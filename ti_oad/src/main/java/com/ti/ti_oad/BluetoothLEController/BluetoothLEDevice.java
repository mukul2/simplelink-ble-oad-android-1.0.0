...
public class BluetoothLEDevice {
    ...
    public int writeCharacteristicAsync(BluetoothGattCharacteristic characteristic, byte[] val) {
        Log.i("mklda", "something wrote "+characteristic.getUuid().toString()+" val "+Arrays.toString(val));
    ...
    public int writeCharacteristicAsync(BluetoothGattCharacteristic characteristic, byte val) {
        ...
        vals[0] = val;
        Log.i("mklda", "something wrote "+characteristic.getUuid().toString()+" val "+Arrays.toString(vals));
       // Log.i("mklda", "something wrote "+characteristic.getUuid().toString()+" val "+TIOADEoadDefinitions.BytetohexString(vals));
       // Log.i("mkl", "setting something at "+characteristic.getUuid().toString()+" and value "+ Arrays.toString(vals));
    ...
    BluetoothGattCallback BluetoothLEDeviceCB = new BluetoothGattCallback() {
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            Log.d(TAG,"onCharacteristicWrite: Wrote to " + characteristic.getUuid().toString()+" val "+Arrays.toString(characteristic.getValue()));
            if (myCB != null) {
